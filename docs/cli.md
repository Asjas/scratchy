...
> information-oriented, lists all CLI commands with their options and generated
> output.
...
- [Overview](#overview)
- [Commands](#commands)
  - [`scratchy make:model`](#scratchy-makemodel-name)
  - [`scratchy make:router`](#scratchy-makerouter-name)
  - [`scratchy make:route`](#scratchy-makeroute-path)
  - [`scratchy make:component`](#scratchy-makecomponent-name)
  - [`scratchy make:page`](#scratchy-makepage-path)
  - [`scratchy make:plugin`](#scratchy-makeplugin-name)
- [Full Scaffold](#full-scaffold)
...
- [Project Structure](./project-structure.md) — Where generated files are placed
- [Data Layer](./data-layer.md) — Schema and query conventions the CLI follows
- [API Design](./api-design.md) — tRPC router patterns generated by
  `make:router`
- [Getting Started](./getting-started.md) — Common development commands
- [Middleware](./middleware.md) — Plugin conventions generated by `make:plugin`
